...
model_path = '/home/tan/tony/dv-det/ckpt-kitti/stage2-diff=3-car_only/test/best_model_0.7473264548998252'
...
nms_idx = rotated_nms3d_idx(roi_attrs, roi_conf, nms_overlap_thresh=0.6, nms_conf_thres=0.7)
