...
model_path = '/home/tan/tony/dv-det/ckpt-kitti/stage2-eval/test/model_0.8206022966128156'
...
if __name__ == '__main__':
    ...
    np.save(join(data_home, 'bbox_predictions_eval.npy'), prediction_output)
