...
os.system("rm -r {}".format('/home/tan/tony/threejs/kitti-stage1-eval'))
Converter = PointvizConverter(home='/home/tan/tony/threejs/kitti-stage1-eval')
...
model_path = '/home/tan/tony/dv-det/ckpt-kitti/stage1-eval/test/model_0.76285055631128' # 68.8%@non-mem-saving
...
input_coors_p, input_features_p, input_num_list_p, _ = model.stage1_inputs_placeholder(input_channels=1)
