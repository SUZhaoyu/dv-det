...
from data.utils.normalization import convert_threejs_bbox_with_prob, convert_threejs_coors, \
    convert_threejs_bbox_with_colors
...
from models.tf_ops.loader.others import rotated_nms3d

model_path = '/home/tan/tony/dv-det/checkpoints/stage1/test/best_model_0.6892320410007045'
...
roi_attrs, roi_conf, nms_idx, nms_count = \
    rotated_nms3d(roi_attrs, roi_conf, nms_overlap_thresh=0.7, nms_conf_thres=0.4)
