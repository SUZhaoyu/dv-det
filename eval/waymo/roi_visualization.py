...
model_path = '/home/tan/tony/dv-det/checkpoints/test/test/best_model_1' # 68.8%@non-mem-saving
...
if __name__ == '__main__':
    with tf.Session(config=config) as sess:
        ...
        for _ in tqdm(range(100000)):
            ...
            output_gt_bboxes, output_bboxes, output_coors, output_conf, output_ious = \
                sess.run([gt_roi_attrs, roi_attrs, roi_coors, roi_conf, roi_ious],
