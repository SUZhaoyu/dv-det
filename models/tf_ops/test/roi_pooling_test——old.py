...
from tf_ops.custom_ops_loader import la_roi_pooling, farthest_point_sample, \
    gather_foreground_points, get_roi_bbox
...
voxels = la_roi_pooling(input_coors=coors,
...
if __name__ == '__main__':
    with tf.Session() as sess:
        ...
        output_coors, output_voxels, output_num_list, output_rois, output_conf = sess.run(
            [center_coors, voxels, center_num_list, roi_attrs, roi_conf],
