...
def stage2_inputs_placeholder(input_feature_channels=256,
                              bbox_padding=config.aug_config['nbbox']):
...
def stage1_model(input_coors,
    ...
    with tf.variable_scope("stage1"):
        ...
        return coors, concat_features, num_list, roi_coors, roi_logits, roi_conf_logits, roi_attrs, roi_num_list
...
def stage2_loss(roi_attrs,
    ...
    tf.summary.scalar('positive_stage2_roi', tf.reduce_sum(bbox_iou_masks))
